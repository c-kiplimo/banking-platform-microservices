...
@Service
@CommandType(entityName = Constants.ACCOUNT, action = Constants.CREATE)
public class CreateAccountCommandHandler implements BusinessCommandHandler<AccountRequest, AccountResponse> {

    private final AccountService accountService;
    private final CustomerClient customerClient;  // inject CustomerClient

    public CreateAccountCommandHandler(AccountService accountService, CustomerClient customerClient) {
